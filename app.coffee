...
exports.ignore_files = ['_*', 'readme*', '.git*', '.DS_Store', 'package.json']
exports.ignore_folders = ['.git', 'node_modules', 'docs', 'documentation', 'test', 'examples']
...
exports.locals =
	...
	repo_url: 'https://github.com/slang800/jGrowl'
	repo_name: 'Thalam.coffee'
